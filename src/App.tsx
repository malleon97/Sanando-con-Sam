        ...
        <div className="container mx-auto px-10 grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] items-center gap-12">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Sanar tu relación con <strong>la comida</strong> y con tu <strong>cuerpo</strong> es posible.
            </h1>
          ...
          >
            ...
            <div className="absolute bottom-0 -right-2 md:-right-10 bg-white p-5 rounded-xl shadow-lila max-w-[220px] border-l-4 border-primary">
